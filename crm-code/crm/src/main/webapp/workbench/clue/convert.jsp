...
<script type="text/javascript">
	$(function(){
		...
		$("#aname").keydown(function (event) {
			if (event.keyCode==13){
				$.ajax({
					url:"workbench/clue/getAlistByAname.do",
					data:{
		...
		$("#convertBtn").click(function () {
			//点击转换按钮，判断是否创建交易，如果创建交易提交表单和线索的id，如果不创建交易，则提交线索id，
...
<%--							</tr>--%>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="form" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="openActBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
