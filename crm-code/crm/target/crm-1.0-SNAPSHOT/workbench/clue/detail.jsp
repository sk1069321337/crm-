	...
	$(function(){
		...
		$("#addAct").click(function () {
			...
			$("#aname").keydown(function (event) {
				if(event.keyCode==13){
						$.ajax({
							url:"workbench/clue/getUserListbyClue.do",
							data:{
...
<%--						</tr>--%>
			...
			<div>
				<a href="javascript:void(0);" id="addAct" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
